$(document).ready(function() {
  $(".input-group button#qr-btn").click(function() {
    // bi-arrow-repeat
    document
      .querySelector(".input-group button i.bi")
      .setAttribute("class", "bi bi-arrow-repeat");
    $.get(`/api/v1/qr?text=${document.querySelector(".input-group input#qr-input").value}`,
      function(res) {
        ...
        res.success == true
          ? document
            ...
            document
              .querySelector(".input-group button i.bi")
              .setAttribute("class", "bi bi-hammer") ||
            document
